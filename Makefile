...
build-darwin:
	...
	tar -C dist/ -czvf ./dist/gitclean.darwin.amd64.tar.gz gitclean
	rm -rf ./dist/gitclean

	GOOS=darwin GOARCH=386 go build -o ./dist/gitclean
	tar -C dist/ -czvf ./dist/gitclean.darwin.386.tar.gz gitclean
	rm -rf ./dist/gitclean

build-freebsd:
	GOOS=freebsd GOARCH=amd64 go build -o ./dist/gitclean
	tar -C dist/ -czvf ./dist/gitclean.freebsd.amd64.tar.gz gitclean
	rm -rf ./dist/gitclean

	GOOS=freebsd GOARCH=386 go build -o ./dist/gitclean
	tar -C dist/ -czvf ./dist/gitclean.freebsd.386.tar.gz gitclean
	rm -rf ./dist/gitclean

build-linux:
	GOOS=linux GOARCH=amd64 go build -o ./dist/gitclean
	tar -C dist/ -czvf ./dist/gitclean.linux.amd64.tar.gz gitclean
	rm -rf ./dist/gitclean

	GOOS=linux GOARCH=386 go build -o ./dist/gitclean
	tar -C dist/ -czvf ./dist/gitclean.linux.386.tar.gz gitclean
	rm -rf ./dist/gitclean

build-windows:
	GOOS=windows GOARCH=amd64 go build -o ./dist/gitclean.exe
	tar -C dist/ -czvf ./dist/gitclean.windows.amd64.tar.gz gitclean.exe
	rm -rf ./dist/gitclean.exe

	GOOS=windows GOARCH=386 go build -o ./dist/gitclean.exe
	tar -C dist/ -czvf ./dist/gitclean.windows.386.tar.gz gitclean.exe
	rm -rf ./dist/gitclean.exe
